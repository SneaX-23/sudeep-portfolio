...
import { Mail, FileText, Github, Linkedin, Twitter, BookOpen} from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="text-center md:text-left space-y-5">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start pt-2">
            ...
            <Link to="/blogs" className="flex items-center gap-2 px-5 py-2.5 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg font-medium hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors border border-blue-200 dark:border-blue-800">
